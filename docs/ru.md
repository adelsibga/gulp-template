...
- Добавить пакет concurrently локально
...
`npm run lint:stylelint:nf` - запустит линтер и выведет в консоль список ошибок.

`npm run lint:stylelint:fix` - дополнительно исправит ошибки, доступные для автоисправления.
...
`npm run lint:eslint:nf` - запустит линтер и выведет в консоль список ошибок.

`npm run lint:eslint:fix` - дополнительно исправит ошибки, доступные для автоисправления.
